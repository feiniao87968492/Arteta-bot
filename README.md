...
基于 NoneBot2 + OneBot V11 的 QQ 群聊机器人，以阿森纳主教练米克尔·阿尔特塔的身份与群成员互动。内置 DeepSeek 大语言模型对话、本地知识库、GrokSearch 实时信息查询、AI 图片生成、好感度系统等功能。
...
- `算法 [题目]` — 理科解题
- `画图 [描述]` — AI 图片生成
- 直接问塔子“积分榜/英超排名/赛程” — Agent 优先用 GrokSearch 和可靠网页来源核实实时信息
- `好感度` / `档案` / `盒` — 好感度系统
- `赞我` — QQ 名片赞
- `发誓 [目标]` — 誓言系统
- `帮助` — 帮助菜单
